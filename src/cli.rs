...
//!
//! - `--fhir` defaults to `5.0.0` (R5) rather than `3.3.0` (decision D4).
...
pub struct Cli {
    ...
    /// FHIR version to use.
    ///
    /// Defaults to 5.0.0 (R5), the current HL7 release — a deliberate
    /// divergence from fhirbase, which defaults to 3.3.0 and stops at 4.0.0
    /// (decision D4). Every version fhirbase supported remains selectable.
    #[arg(
        short = 'f',
        long = "fhir",
        global = true,
...
mod tests {
    ...
    fn defaults_match_the_spec() {
        ...
        assert_eq!(cli.fhir, "5.0.0", "decision D4: R5 is the default");
