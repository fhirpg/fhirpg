...
fifteen catalogued defects and modernizes the target platform. See
[`plan.md`](plan.md).
...
- **Cite the Go source.** When porting a unit, name the fhirbase file and line
  ...
  checkout.
- **Fix the catalogued defects, do not reproduce them.** X1-X15 in `plan.md`.
...
| [`plan.md`](plan.md) | Phases, decisions D1-D14, divergences X1-X15, risks |
